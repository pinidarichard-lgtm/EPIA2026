  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={S.topBar}>
        ...
        <div style={S.btnRow}>
          <button style={S.btnIB} onClick={() => navigate("/admin/dashboard")}>📊 Tableau de bord</button>
          <button style={S.btnIB} onClick={() => navigate("/admin/matieres-ecole")}>🏫 Matières école</button>
          <button style={S.btnIB} onClick={() => navigate("/admin/matieres-ib")}>⚙️ Matières IB</button>
          <button style={S.btnIB} onClick={() => navigate("/admin/annees-scolaires")}>📅 Années</button>
          <button style={S.btnIB} onClick={() => navigate("/admin/eleve-matieres")}>📚 Matières élèves</button>
          <button style={S.btnIB} onClick={() => navigate("/admin/prof-matieres")}>👩‍🏫 Matières profs</button>
        </div>
      </div>
            ...
            <div key={u.id} style={S.card}>
              <div style={S.row}>
                ...
                <div style={{ display:"flex", gap:6, flexWrap:"wrap" }}>
                  <button style={S.btnSm} onClick={() => navigate(`/admin/bulletin/${u.id}`)}>📊 Bulletin</button>
