  ...
  return (
    <div style={{ paddingTop: '1.5rem', paddingBottom: '3rem' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'inline-block', background: '#e8b84b', color: '#1a3a5c', fontSize: 11, fontWeight: 700, padding: '4px 14px', borderRadius: 20, letterSpacing: 1, marginBottom: '0.75rem' }}>
            ÉCOLE ACCRÉDITÉE IB
          </div>
          ...
          <p style={{ fontSize: 15, opacity: 0.85, lineHeight: 1.6, maxWidth: 520 }}>
            Établissement scolaire accrédité par le Baccalauréat International, 
            offrant le Programme du Diplôme à Lomé, Togo. 
            Première promotion D1 en 2024–2025, D2 en 2025–2026.
          </p>
          <div style={{ display: 'flex', gap: '10px', marginTop: '1rem', flexWrap: 'wrap' }}>
            <span style={{ background: 'rgba(232,184,75,0.2)', border: '1px solid #e8b84b', color: '#e8b84b', fontSize: 12, fontWeight: 600, padding: '4px 12px', borderRadius: 20 }}>
              🎓 D1 — 2024–2025
            </span>
            <span style={{ background: 'rgba(232,184,75,0.2)', border: '1px solid #e8b84b', color: '#e8b84b', fontSize: 12, fontWeight: 600, padding: '4px 12px', borderRadius: 20 }}>
              🎓 D2 — 2025–2026
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <InfoCard color="#7a3e1a" icon="⭐" title="Mission de l'école">
          ...
          <p style={{ marginTop: 10 }}>Dotée d'équipements performants, l'Ecole Alpha s'inscrira dans l'excellence et donnera à tous les enseignants la possibilité d'évoluer sur le plan individuel et professionnel.</p>
        </InfoCard>
        ...
        <InfoCard color="#2a5280" icon="📚" title="Programme du Diplôme IB">
          ...
          <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ background: '#eef2f7', borderRadius: 8, padding: '8px 12px', fontSize: 13 }}>
              <strong style={{ color: '#1a3a5c' }}>1ère promotion (D1)</strong> — Année scolaire 2024–2025
            </div>
            <div style={{ background: '#eef2f7', borderRadius: 8, padding: '8px 12px', fontSize: 13 }}>
              <strong style={{ color: '#1a3a5c' }}>2ème année (D2)</strong> — Année scolaire 2025–2026
            </div>
          </div>
          <a href="http://www.ibo.org/fr/" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginTop: 12, color: '#1a3a5c', fontSize: 13, fontWeight: 600 }}>
            → En savoir plus sur ibo.org
          </a>
        </InfoCard>
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        <a href="/plans" style={{ display: 'inline-block', background: '#e8b84b', color: '#1a3a5c', textDecoration: 'none', padding: '12px 28px', borderRadius: 8, fontWeight: 700, fontSize: 15 }}>
          Accéder aux plans d'unité →
        </a>
      </div>
    </div>
  )
