...
.school-name { font-size: 10pt; opacity: 0.75; }
.school-sub { font-size: 9pt; opacity: 0.55; }
...
.meta { font-size: 10pt; opacity: 0.82; display: flex; flex-wrap: wrap; gap: 14px; margin-top: 6px; }
...
.row-label { font-size: 7.5pt; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: #aaa; margin-bottom: 2px; }
...
<div class="page">
  <div class="header">
    <div class="header-top">
      <div class="logo-circle">IB</div>
      <div>
        <div class="school-name">L'EPIA — École Pilote Innovante Alpha de Lomé, Togo</div>
        <div class="school-sub">Programme du Diplôme</div>
      </div>
    </div>
